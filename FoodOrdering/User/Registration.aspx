                ...
                <div class="col-md-6">
                    <div class="form_container">
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revName" runat="server" ErrorMessage="Name should be valid characters"
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfvMobile" runat="server" ErrorMessage="Phone number is required!" ControlToValidate="txtMobile"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revMobile" runat="server" ErrorMessage="Phone number must be 10 or 11 digits long"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true" ValidationExpression="^[0-9]{9,10}$"
                    ...
                    <div class="form_container">
                        ...
                        <div>
                            <asp:RequiredFieldValidator ID="rfvPostcode" runat="server" ErrorMessage="Post/Zip Code is required!" ControlToValidate="txtPostcode"
                                ForeColor="Red" Display="Dynamic" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="revPostcode" runat="server" ErrorMessage="Post/Zip must be 5 digits"
