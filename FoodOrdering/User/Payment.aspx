<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="FoodOrdering.User.Payment" %>
            ...
            <div class="row pb-5">
                <div class="col-lg-6 mx-auto">
                    <div class="card ">
                        ...
                        <div class="card-footer">
                            <b class="badge badge-success badge-pill shadow-sm">Order Total: RM <% Response.Write(Session["grandTotalPrice"]); %> </b>
                            <div class="pt-1">
