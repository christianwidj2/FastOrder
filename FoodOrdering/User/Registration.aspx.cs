    ...
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            if (fuUserImage.HasFile)
            {
                ...
                {
                    lblMsg.Visible = true;
                    lblMsg.Text = "Only .jpg, .jpeg, and .png images are allowed";
            ...
            if (isValidToExecute)
            {
                ...
                try
                {
                    ...
                    cmd.ExecuteNonQuery();
                    actionName = userId == 0 ?
                        "Registration Success! <b><a href='Login.aspx'>Click Here</a></b> to Sign In" :
                        "Details Updated! <b><a href='Profile.aspx'>See Your Update</a></b>";
                    lblMsg.Visible = true;
                ...
                catch (SqlException ex)
                {
                    ...
                    {
                        lblMsg.Visible = true;
                        lblMsg.Text = "<b>" + txtUsername.Text.Trim() + "</b> username already exist, try a different one!";
                        lblMsg.CssClass = "alert alert-danger";
                    }
                }
                catch (Exception ex)
