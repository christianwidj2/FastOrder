<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="FoodOrdering.User.Profile" %>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <ul class="nav nav-tabs mb-4" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-info" id="connectedServices-tab" data-toggle="tab" href="#connectedServices" role="tab"
                                                aria-controls="connectedServices" aria-selected="false"><i class="fa fa-clock-o mr-2"></i>Purchase History</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content ml-1" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade show" id="connectedServices" role="tabpanel" aria-labelledby="connectedServices-tab">
                                                ...
                                                <ItemTemplate>
                                                    <div class="container">
                                                        <div class="row pt-1 pb-1" style="background-color: lightgray">
                                                            ...
                                                            <div class="col-6">
                                                                <%# string.IsNullOrEmpty( Eval("CardNo").ToString() ) ? "" : "Card No: " + Eval("CardNo").ToString()%>
                                                            </div>
                                                        ...
                                                        <asp:Repeater ID="rOrders" runat="server">
                                                            ...
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:Label ID="lblPrice" runat="server" Text='<%# string.IsNullOrEmpty( Eval("Price").ToString() ) ? "" : "RM " + Eval("Price").ToString() %>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:Label ID="lblQuantity" runat="server" Text='<%# Eval("Quantity") %>'></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        RM <asp:Label ID="lblTotalPrice" runat="server" Text='<%# Eval("TotalPrice").ToString() %>'></asp:Label>
                                                                    </td>
                                                                    <td>
