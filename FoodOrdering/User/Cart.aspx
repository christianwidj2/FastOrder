                ...
                <asp:Repeater ID="rCartItem" runat="server" OnItemCommand="rCartItem_ItemCommand" OnItemDataBound="rCartItem_ItemDataBound">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <img width="30" src="<%# Utils.GetImageUrl(Eval("ImageUrl")) %>" alt="" />
                            </td>
                            <td>RM <asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'></asp:Label>
                            ...
                            <td>RM <asp:Label ID="lblTotalPrice" runat="server"></asp:Label>
                            </td>
                            <td>
                    ...
                    <FooterTemplate>
                        <tr>
                            ...
                            <td>RM <% Response.Write(Session["grandTotalPrice"]); %>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            <td colspan="2" class="continue__btn">
                                <a href="Menu.aspx" class="btn btn-info btn-block"><i class="fa fa-plus-circle mr-2"></i>Add More Item</a>
                            </td>
                            <td colspan="2">
                                <asp:LinkButton ID="lbUpdateCart" runat="server" CommandName="updateCart" CssClass="btn btn-warning btn-block">
                                    <i class="fa fa-refresh mr-2"></i>Update Cart
                                </asp:LinkButton>
                            </td>
                            <td colspan="2">
                                <asp:LinkButton ID="lbCheckout" runat="server" CommandName="checkout" CssClass="btn btn-success btn-block">
